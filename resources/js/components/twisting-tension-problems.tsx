...
export default function TwistingProblemReport({
  onBack,
  spindleNumber,
  submittedProblems,
  ...
  const submitProblem = () => {
    if (currentProblem.trim()) {
      ...
      console.log("Problem submitted for Spindle", spindleNumber, ":", currentProblem)
    }
  }
    ...
    <div className="flex items-center justify-center min-h-screen bg-background p-2">
      <Card className="w-full max-w-xs mx-auto shadow-lg">
        <CardHeader className="pb-2">
          ...
          <div className="text-sm text-center text-muted-foreground">Reporting for Spindle #{spindleNumber}</div>
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex items-center gap-1 mb-1">
                        <span className="text-xs font-semibold text-blue-600">Spd #{problem.spindleNumber}</span>
                      </div>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="space-y-2">
            <label htmlFor="problem-description" className="text-xs font-medium text-foreground">
              Describe the problem for Spindle #{spindleNumber}:
            </label>
            <Textarea
              id="problem-description"
              placeholder={`Enter problem description for Spindle ${spindleNumber}...`}
          ...
          <div className="space-y-2">
            ...
            >
              Submit Problem for Spd #{spindleNumber}
            </Button>
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button
                variant="outline"
                size="sm"
                className="h-10 text-sm font-medium hover:bg-destructive hover:text-destructive-foreground transition-colors bg-transparent"
              ...
              <Button
                variant="outline"
                size="sm"
                className="h-10 text-sm font-medium hover:bg-accent hover:text-accent-foreground bg-transparent"
                onClick={goBack}
              >
